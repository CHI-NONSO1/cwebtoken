...
class Approve extends React.Component {
  ...
  async _approveTokens(spender, amount) {
    try {
      this._dismissTransactionError();

      const tx = await this._token.approve(spender, amount);
      ...
      await this._getAllowedBalance(spender);
  ...
  async _getTransactionEvent() {
    this._token.on("Approval", (owner, spender, value, event) => {
      let info = {
        giver: owner,
        spender: spender,
      ...
      this.setState({ approvedAmount: info });
    });
  }
        ...
        <div className="alert-box">
          <div className="alert-success">
            {this.state.approvedAmount === undefined ? null : (
              <div>
                <div>Giver: {this.state.approvedAmount.giver}</div>
                <div>Spender: {this.state.approvedAmount.spender}</div>
                <div>Value: {this.state.approvedAmount.value}</div>
              </div>
            )}
          </div>
          <div className="alert-success">
              ...
              <div className="form-items">
                ...
                <form
                  onSubmit={(event) => {
                    ...
                    if (spender && amount) {
                      this._approveTokens(spender, amount);
                    }
                  }}
                >

...
export class Home extends React.Component {
        ...
        <div className="content-items">
          <div className="content-box">
            ...
            <div className="nav-items">
              <NavLink
                onClick={() => {}}
                to={`/transfer/${this.state.selectedAddress}`}
              >
                Transfer
              </NavLink>
              <NavLink
                onClick={() => {}}
                to={`/approval/${this.state.selectedAddress}`}
              >
                Approval
              </NavLink>
              ...
              <NavLink
                onClick={() => {}}
                to={`/allowance/${this.state.selectedAddress}`}
              >
                Allowance
              </NavLink>
              ...
              <NavLink
                onClick={() => {}}
                to={`/transfer-from/${this.state.selectedAddress}`}
              >
                Transfer From
              </NavLink>
            </div>
  ...
  _checkNetwork() {
    ...
    // });
    console.log(GOERLI_NETWORK_ID, window.ethereum.networkVersion);
